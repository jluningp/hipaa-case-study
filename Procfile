...
#     echo '{ "name": "yesod-buildpack-demo", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/yesod-buildpack-demo/yesod-buildpack-demo
#     git commit -m deploy
#
# * push to Heroku
#
...
web: .stack-work/dist/x86_64-linux/Cabal-1.24.2.0/build/hipaa/hipaa stack.yaml
